SampleSubmissionController = function(scope,RequestSender,rootScope,location,paginatorService,localStorageService, API_VERSION,sessionManager,filter,routeParams,dateFilter,route) 
{
...
selfcareApp.controller('SampleSubmissionController', ['$scope',
                                             'RequestSender',
                                             '$rootScope',
                                             '$location',
                                             'PaginatorService', 

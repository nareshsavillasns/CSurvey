selfcareApp.config(function($routeProvider, $locationProvider) {
    ...
    .when('/allsubmission', {
        templateUrl: 'views/allsubmission.html'
    })
    .when('/statements', {
    ...
    .when('/samplesubmission',{
    	templateUrl: 'views/samplesubmission.html'
     })
 ...
 .when('/worldpayredirection',{
    	...
    	templateUrl: 'views/stripepay.html'
    })
    .when('/stripepayredirection',{
    	templateUrl: 'views/stripepayredirection.html'
    })
     .when('/worldpay',{
